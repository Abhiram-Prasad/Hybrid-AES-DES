...
int hexa_to_binary(int ch,char output[],int j)
{
	if(ch == 48) {output[j++]='0';output[j++]='0';output[j++]='0';output[j++]='0';}
	if(ch == 49) {output[j++]='0';output[j++]='0';output[j++]='0';output[j++]='1';}
	if(ch == 50) {output[j++]='0';output[j++]='0';output[j++]='1';output[j++]='0';}
	if(ch == 51) {output[j++]='0';output[j++]='0';output[j++]='1';output[j++]='1';}
	if(ch == 52) {output[j++]='0';output[j++]='1';output[j++]='0';output[j++]='0';}
	if(ch == 53) {output[j++]='0';output[j++]='1';output[j++]='0';output[j++]='1';}
	if(ch == 54) {output[j++]='0';output[j++]='1';output[j++]='1';output[j++]='0';}
	if(ch == 55) {output[j++]='0';output[j++]='1';output[j++]='1';output[j++]='1';}
	if(ch == 56) {output[j++]='1';output[j++]='0';output[j++]='0';output[j++]='0';}
	if(ch == 57) {output[j++]='1';output[j++]='0';output[j++]='0';output[j++]='1';}
	if(ch == 97) {output[j++]='1';output[j++]='0';output[j++]='1';output[j++]='0';}
	if(ch == 98) {output[j++]='1';output[j++]='0';output[j++]='1';output[j++]='1';}
	if(ch == 99) {output[j++]='1';output[j++]='1';output[j++]='0';output[j++]='0';}
	if(ch == 100) {output[j++]='1';output[j++]='1';output[j++]='0';output[j++]='1';}
	if(ch == 101) {output[j++]='1';output[j++]='1';output[j++]='1';output[j++]='0';}
	if(ch == 102) {output[j++]='1';output[j++]='1';output[j++]='1';output[j++]='1';}
...
int main()
{
	...
	while(1)
    {
        ...
        for(i=0;i<16;i++)
        {
			...
			k = hexa_to_binary(ch,plaintext,k);
        }
        if(flag == 1)
        	break;
        plaintext[k]='\0';
